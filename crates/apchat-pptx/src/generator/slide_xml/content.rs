...
fn generate_code_block(id: usize, code_block: &crate::generator::slide_content::CodeBlock) -> String {
    // For now, generate simple code block without syntax highlighting
    // TODO: Add proper syntax highlighting
    let code_text = crate::generator::package_xml::escape_xml(&code_block.code);
    let x = code_block.x;
    let y = code_block.y;
...
<a:lstStyle/>
<a:p><a:r><a:rPr lang="en-US" sz="1800" dirty="0"><a:latin typeface="Consolas"/><a:solidFill><a:srgbClr val="C7254E"/></a:solidFill></a:rPr><a:t>{code_text}</a:t></a:r></a:p>
</p:txBody>
</p:sp>"#
    )
}
