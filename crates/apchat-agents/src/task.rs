...
pub struct TaskContextBuilder {
    ...
    tool_registry: Option<std::sync::Arc<apchat_toolcore::tool_registry::ToolRegistry>>,
    llm_client: Option<std::sync::Arc<dyn crate::agent::LlmClient>>,
    conversation_history: Vec<crate::agent::ChatMessage>,
    terminal_manager: Option<std::sync::Arc<tokio::sync::Mutex<apchat_terminal::TerminalManager>>>,
    skill_registry: Option<std::sync::Arc<apchat_skills::SkillRegistry>>,
    todo_manager: Option<std::sync::Arc<apchat_todo::TodoManager>>,
...
impl TaskContextBuilder {
    ...
    pub fn with_tool_registry(mut self, registry: std::sync::Arc<apchat_toolcore::tool_registry::ToolRegistry>) -> Self {
    ...
    pub fn with_terminal_manager(mut self, terminal_manager: std::sync::Arc<tokio::sync::Mutex<apchat_terminal::TerminalManager>>) -> Self {
        self.terminal_manager = Some(terminal_manager);
        self
    }

    pub fn with_skill_registry(mut self, skill_registry: std::sync::Arc<apchat_skills::SkillRegistry>) -> Self {
        self.skill_registry = Some(skill_registry);
        self
    }

    pub fn with_todo_manager(mut self, todo_manager: std::sync::Arc<apchat_todo::TodoManager>) -> Self {
