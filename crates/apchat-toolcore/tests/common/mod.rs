...
use apchat_models::tools::{Tool, ToolParameter, ToolParameterType, ToolCategory};
...
pub mod assertions {
    ...
    use apchat_models::tools::{Tool, ToolParameter};
...
pub mod mocks {
    use super::*;
    use apchat_models::tools::ToolCategory;
