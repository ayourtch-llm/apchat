...
should continue working as they do now. Also: pay attention, since the input is now possible at any time, there now needs to be a way to ensure the input is not clobbered, and also to take in the confirmation prompts (somehow from input ?)
