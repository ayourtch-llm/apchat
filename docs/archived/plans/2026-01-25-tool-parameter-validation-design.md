...
**Example:**
```
"Tool 'read_file' has invalid parameter 'invalid_param'. Available: offset, end_line, file_path, limit. Missing required parameter: file_path"
```
...
- `read_file` tool (parameters: file_path, offset, end_line, limit)
